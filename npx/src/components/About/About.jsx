...
const about = ()=> {
    return <section>
      ...
      <div className="flex justify-between gap-[50px] lg:ga-[130px] xl:gap-0 flex-col lg:flex-row">
        ...
        {/* ============= about img ==============*/}
        <div className="w-fll lg:w-1/2 xl:w-[670px] order-1 lg:order-2">
        ...
        <p className="text_para mt-[30px]">
            ...
            patients-not looking back at what we accomlished but towards what
            we can do tomorrow.Providing the best.Lorem ipsum dolor sit 
            amet, consectetur adipisicing elit.Aliquide,modi?
        </p>
        <link to="/">
